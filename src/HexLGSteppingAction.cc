...
HexLGSteppingAction::HexLGSteppingAction(HexLGEventAction* ea)
  : fOneStepPrimaries(false),
    fEventAction(ea)
{
  fSteppingMessenger = new HexLGSteppingMessenger(this);
...
HexLGSteppingAction::~HexLGSteppingAction() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void HexLGSteppingAction::UserSteppingAction(const G4Step * theStep){

  G4Track* theTrack = theStep->GetTrack();

  if ( theTrack->GetCurrentStepNumber() == 1 ) fExpectedNextStatus = Undefined;
 
  HexLGUserTrackInformation* trackInformation
    =(HexLGUserTrackInformation*)theTrack->GetUserInformation();
