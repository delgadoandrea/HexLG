...
G4ThreadLocal G4Allocator<HexLGTrajectory>* HexLGTrajectoryAllocator = nullptr;
...
HexLGTrajectory::HexLGTrajectory(const G4Track* aTrack)
...
HexLGTrajectory::HexLGTrajectory(HexLGTrajectory &right)
...
void HexLGTrajectory::DrawTrajectory() const
{
