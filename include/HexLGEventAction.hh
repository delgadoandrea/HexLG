#ifndef HexLGEventAction_h
#define HexLGEventAction_h 1
...
class HexLGEventAction : public G4UserEventAction
{
  public:

    HexLGEventAction(const HexLGDetectorConstruction*);
    virtual ~HexLGEventAction();
